...
import { getUserBookings, updateUser } from '../services/api';
                                ...
                                <div style={{ textAlign: 'center', marginBottom: '20px' }}>
                                    <div style={{ width: '100px', height: '100px', borderRadius: '50%', backgroundColor: '#f1f5f9', margin: '0 auto 10px', overflow: 'hidden' }}>
                                        {previewUrl ? <img src={previewUrl} alt="Preview" style={{ width: '100%', height: '100%', objectFit: 'cover' }} /> : (
                                            user.profile_picture ? <img src={`http://localhost:5001/uploads/${user.profile_picture}`} alt="" style={{ width: '100%', height: '100%', objectFit: 'cover' }} /> : null
                                        )}
                                    </div>
