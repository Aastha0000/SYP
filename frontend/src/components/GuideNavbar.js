    ...
    return (
        <nav className="navbar navbar--solid" style={{ backgroundColor: '#2d6a4f', display: 'flex', alignItems: 'center', padding: '10px 40px' }}>
            ...
            <div style={{ marginLeft: '40px', display: 'flex', alignItems: 'center', gap: '30px' }}>
                ...
                <Link to="/location" style={{ color: 'white', textDecoration: 'none', display: 'flex', alignItems: 'center', transition: 'transform 0.2s' }} title="Live Location">
                    <svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" strokeWidth="1.5" fill="none" strokeLinecap="round" strokeLinejoin="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path><circle cx="12" cy="10" r="3"></circle></svg>
                </Link>
