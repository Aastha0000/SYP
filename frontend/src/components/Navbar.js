    ...
    return (
        <nav className={`navbar ${transparent ? 'navbar--transparent' : 'navbar--solid'}`}>
            ...
            <ul className="navbar__links">
                ...
                {token && user?.role === 'user' && <li><Link to="/user/favorites">Favourites</Link></li>}
            ...
            <div className="navbar__user">
                {token ? (
                    <div className="navbar__user-menu" style={{display: 'flex', alignItems: 'center', gap: '25px'}}>
                        ...
                        <Link to="/location" style={{ position: 'relative', color: 'white', textDecoration: 'none', display: 'flex', alignItems: 'center' }} title="Live Location">
