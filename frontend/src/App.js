  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/location" element={<ProtectedRoute allowedRoles={['user', 'guide']}><LiveLocation /></ProtectedRoute>} />
        ...
        <Route path="/user/favorites" element={<ProtectedRoute allowedRoles={['user']}><Favorites /></ProtectedRoute>} />
